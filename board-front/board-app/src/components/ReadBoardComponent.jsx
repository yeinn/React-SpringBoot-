            ...
            <div>
                <div className = "card col-md-6 offset-md-3">
                    ...
                    <div className="card-body">
                        ...
                        {this.returnDate(this.state.board.createTime, this.state.board.updatedTime)}

                        <button className="btn btn-primary" onClick={this.goToList.bind(this)}>글목록으로 이동 </button>
